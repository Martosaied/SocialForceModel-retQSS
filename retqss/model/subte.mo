...
parameter Real
	...
	OUTPUT_UPDATE_DT = getRealModelParameter("OUTPUT_UPDATE_DT", 0.5),
	PROGRESS_UPDATE_DT = getRealModelParameter("PROGRESS_UPDATE_DT", 0.01),
	DESTINATION_UPDATE_DT = getRealModelParameter("DESTINATION_UPDATE_DT", 50.0),
...
parameter Real
	...
	INCUBATION_TIME_M = 	getRealModelParameter("INCUBATION_TIME_M", 10000),		// https://bmjopen.bmj.com/content/10/8/e039652
	INCUBATION_TIME_S = 	getRealModelParameter("INCUBATION_TIME_S", 10000),		//
	PRESYMPTOMATIC_TIME_M = getRealModelParameter("PRESYMPTOMATIC_TIME_M", 200000),		// https://www.researchgate.net/publication/344358423_SARS-CoV-2_transmission_dynamics_should_inform_policy/link/5fb1970492851cf24cd57da1/download
	PRESYMPTOMATIC_TIME_S = getRealModelParameter("PRESYMPTOMATIC_TIME_S", 0.5),	// CI95% [1, 3]
	SYMPTOMATIC_TIME_M = 	getRealModelParameter("SYMPTOMATIC_TIME_M", 100000),		// https://www.researchgate.net/publication/344358423_SARS-CoV-2_transmission_dynamics_should_inform_policy/link/5fb1970492851cf24cd57da1/download
