 ...
 */
typedef void
(*FRW_recomputeDerivativesFn)(FRW_framework, QSS_model, QSS_data, QSS_time,
    int);
 ...
 */
typedef void
(*FRW_nextInputTimeFn)(FRW_framework, QSS_model, QSS_data, QSS_time, double,
    int, int);
 ...
 */
void
FRW_freeFrameworkOps(FRW_frameworkOps f);
