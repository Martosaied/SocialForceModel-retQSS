...
class RunDlg: public QDialog, public Ui::RunForm
{
  Q_OBJECT
    ...
    void
    on__solver_currentIndexChanged (int index);
    void
    on__debugChk_stateChanged (int state);
    void
    on__plotVarsChk_stateChanged (int state);
    void
    ...
    bool
    _selectedSolverSupportsDebugPlots();
    Utils *_utils;
