...
Utils::appCommand(AppCmds c)
{
  ...
  {
    case CMD_COMPILE:
      cmd = settings.value("Commands/comp",
          "Value not found in file qss-solver.ini").toString();
      break;
    case CMD_BUILD:
      cmd = settings.value("Commands/build",
          "Value not found in file qss-solver.ini").toString();
      break;
    case CMD_SIMULATE:
      cmd = settings.value("Commands/simulate",
          "Value not found in file qss-solver.ini").toString();
      break;
    case CMD_PLOT:
      cmd = settings.value("Commands/plot",
          "Value not found in file qss-solver.ini").toString();
      break;
    case CMD_SBML:
      cmd = settings.value("Commands/sbml",
          "Value not found in file qss-solver.ini").toString();
      break;
    case CMD_LOG:
      cmd = settings.value("Commands/log",
          "Value not found in file qss-solver.ini").toString();
      break;
    case CMD_PLOT_DEBUG:
      cmd =
           settings.value ("Commands/plotDebug",
          "Value not found in file qss-solver.ini").toString ();
      break;
    default:
      return QString();
...
Utils::isSet(AppFlags f)
{
  ...
  {
    case FLG_FLAGS:
      _val = settings.value("Flags/flags",
          "Value not found in file qss-solver.ini").toString();
      break;
    case FLG_DEBUG:
    ...
    case FLG_DBG_INIT_VALUES:
      _val = settings.value("Flags/dbgInitValues",
          "Value not found in file qss-solver.ini").toString();
      return _val == "true";
    case FLG_DBG_EXTERNAL_EVENT:
      _val = settings.value("Flags/dbgExternalEvent",
          "Value not found in file qss-solver.ini").toString();
      return _val == "true";
    case FLG_DBG_MEMORY:
      _val = settings.value("Flags/dbgMemory",
          "Value not found in file qss-solver.ini").toString();
      return _val == "true";
    case FLG_DBG_SYNCHRONIZE:
      _val = settings.value("Flags/dbgSynchronize",
          "Value not found in file qss-solver.ini").toString();
      return _val == "true";
    case FLG_DBG_STEP_INFO:
      _val = settings.value("Flags/dbgStepInfo",
          "Value not found in file qss-solver.ini").toString();
      return _val == "true";
    case FLG_DBG_VAR_CHANGES:
      _val = settings.value("Flags/dbgVarChanges",
          "Value not found in file qss-solver.ini").toString();
      return _val == "true";
    case FLG_DBG_WAIT_FOR:
      _val = settings.value("Flags/dbgWaitFor",
          "Value not found in file qss-solver.ini").toString();
      return _val == "true";
    case FLG_DBG_WEIGHTS:
      _val = settings.value("Flags/dbgWeights",
          "Value not found in file qss-solver.ini").toString();
      return _val == "true";
    case FLG_DBG_DT:
      _val = settings.value("Flags/dbgDt",
          "Value not found in file qss-solver.ini").toString();
      return _val == "true";
    default:
      return _val.isEmpty();
...
Utils::appFlag(AppFlags f)
{
  ...
  switch(f)
  {
    ...
    case FLG_DBG_DT:
      ...
      break;
    case FLG_PLOT:
      _val = settings.value("Flags/plotflags",
          "Value not found in file qss-solver.ini").toString();
      break;
    case FLG_VERSION:
      _val = settings.value("Flags/version",
          "Value not found in file qss-solver.ini").toString();
      break;
    case FLG_REVISION:
      _val = settings.value("Flags/revision",
          "Value not found in file qss-solver.ini").toString();
      break;
    default:
      break;
...
QString
Utils::relativePath(AppDirs d)
{
  return _getDir(d);
}

QString
Utils::_getDir(AppDirs d)
{
  QSettings settings(QCoreApplication::applicationDirPath() + "/qss-solver.ini",
      QSettings::IniFormat);
  QString path;
...
void
Utils::setCommand(AppCmds c, QString value)
{
  QSettings settings(QCoreApplication::applicationDirPath() + "/qss-solver.ini",
      QSettings::IniFormat);
  switch(c)
...
void
Utils::setDir(AppDirs d, QString value)
{
  QSettings settings(QCoreApplication::applicationDirPath() + "/qss-solver.ini",
      QSettings::IniFormat);
  switch(d)
...
void
Utils::setFlag(AppFlags f, QString value)
{
  QSettings settings(QCoreApplication::applicationDirPath() + "/qss-solver.ini",
      QSettings::IniFormat);
  switch(f)
