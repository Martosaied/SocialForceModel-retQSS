...
{
  DBG_PLOT_SUCCESS,
  DBG_PLOT_ERR_DEFAULT,
  DBG_PLOT_ERR_MATPLOTLIB,
  DBG_PLOT_ERR_PARSING,
  DBG_PLOT_ERR_UNKNOWN_VAR,
  DBG_PLOT_ERR_PLOTTING
} DbgPlotExitCodes;
...
class MmomeGui: public QMainWindow, public Ui::MmomeGuiForm
{
  Q_OBJECT
    ...
    on_debugPlotStarted();
    void
    on_debugPlotError(QProcess::ProcessError);
    void
    on_debugPlotFinished(int exitCode, QProcess::ExitStatus exitStatus);
    void
    runDlgClose();
    void
    runDlgRejected();
