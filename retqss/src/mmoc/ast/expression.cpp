...
AST_Expression_ComponentReference_::AST_Expression_ComponentReference_() :
    _name(newAST_StringList()), _indexes(newAST_ExpressionListList()), _original(nullptr)
{
}
...
void AST_Expression_ComponentReference_::setOriginalExp(AST_Expression original) { _original = original; }

AST_Expression AST_Expression_ComponentReference_::originalExp() { return _original; }
