...
class QSS_: public MMO_Solver_
{
  public:
    ...
    _indexDependencies(Index idx, Index *dIdx, Index infIdx, Index *infDIdx,
        ...
        Intersection intersection, int assignments, DEP_Type type = DEP_STATE);
    void
    ...
    bool
    _hasPrevIntersections(Index event_def, map<Index, Index> events, Intersection new_intersection,
