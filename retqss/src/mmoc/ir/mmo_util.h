...
class MMO_ModelData_
{
  public:
    ...
    disableSymDiff();
    void
    setOutputVariables(VarSymbolTable outputVariables);
    bool
    isFunctionOutputVariable(VarName name);
    bool isFunction();
    void setFunction(bool func);
    void setLocalPackageFuncs(map<string,string> local_package_funcs) { _local_package_funcs = local_package_funcs; }
    string searchLocalPackageFuncs(string name);
    void setFunctionPrefix(string pref) { _function_prefix = pref; }
    string functionPrefix() { return _function_prefix; }
    void setOutputArray(bool output_array) { _output_array = output_array; }
    bool outputArray() { return _output_array; }
    private:
    ...
    VarSymbolTable _output_function_symbols;
    bool _is_function;
    map<string,string> _local_package_funcs;
    string _function_prefix;
    bool _output_array;
};
/**
 *
