...
PEDESTRIANS_IMPLEMENTATION = {
    ...
    Constants.PEDESTRIAN_MMOC: "retqss baseline",
}
WIDTH = 20
GRID_SIZE = 50
...
def breaking_lanes():
    ...
    for cell_size in CELL_SIZES:
            print(f"Ejecutando experimento para tamaño de celda {cell_size}m con implementación {PEDESTRIANS_IMPLEMENTATION[Constants.PEDESTRIAN_NEIGHBORHOOD]}...")
            run(cell_size, PEDESTRIANS_IMPLEMENTATION[Constants.PEDESTRIAN_NEIGHBORHOOD])
            print(f"Experimento para tamaño de celda {cell_size}m con implementación {PEDESTRIANS_IMPLEMENTATION[Constants.PEDESTRIAN_NEIGHBORHOOD]} completado.\n")
